...
// NOTE:Java enum icindeki datas lari upper case ile yazilir.
    ...
    private final String statesName;//ulkeler icin
    private final String abbreviation;
    private final String Capital;

    UsStatesEnum(String statesName, String abbreviation, String capital) {
 ...
 ////State kisaltmasini verince state'in ismini veren method
    public static  String getStateNameByUsingAbbreviation(String abbreviation){
        return Arrays.stream(values())
                ...
                .findFirst().get().getStatesName();


    }
//state ismini verince state nin abbr. sini veren method olusturalim.
    public static String getAbbreviationForStateName(String stateName) {
        return Arrays.stream(values())
                .filter(usState -> usState.getStatesName().equals(stateName))
